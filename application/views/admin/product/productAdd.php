        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input class="form-control" type="text" name="nama_product" value="<?= set_value('nama_product'); ?>" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="number" class="form-control" name="stock" min="1" required value="<?= set_value('stock'); ?>">
